...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //Get Avatar and coverImage path
...
const refreshAccessToken = asyncHandler(async(req,res)=>{
 ...
 try {
   ...
   res.status(200).cookie("accessToken",accessToken,options).cookie("refreshToken",refreshToken,options).json(new ApiResponse(200,{accessToken,refreshToken},"Access token refreshed"))
